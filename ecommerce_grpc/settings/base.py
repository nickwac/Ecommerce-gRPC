"""
Base settings for ecommerce_grpc project.
...
ROOT_URLCONF = 'ecommerce_grpc.urls'
...
WSGI_APPLICATION = 'ecommerce_grpc.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'E-Commerce gRPC API',
    'DESCRIPTION': 'Professional e-commerce API with gRPC microservices',
    'VERSION': '2.0.0',
